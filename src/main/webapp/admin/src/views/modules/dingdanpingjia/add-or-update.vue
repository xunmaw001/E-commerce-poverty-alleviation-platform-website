  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="订单编号" prop="dingdanbianhao">
              <el-input v-model="ruleForm.dingdanbianhao" 
                placeholder="订单编号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="评价标题" prop="pingjiabiaoti">
          <el-input v-model="ruleForm.pingjiabiaoti" 
              placeholder="评价标题" clearable  :readonly="ro.pingjiabiaoti"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="评价标题" prop="pingjiabiaoti">
              <el-input v-model="ruleForm.pingjiabiaoti" 
                placeholder="评价标题" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="订单评分" prop="dingdanpingfen">
          <el-select v-model="ruleForm.dingdanpingfen" placeholder="请选择订单评分">
            <el-option
                v-for="(item,index) in dingdanpingfenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="订单评分" prop="dingdanpingfen">
	      <el-input v-model="ruleForm.dingdanpingfen"
                placeholder="订单评分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
          ...
          <el-form-item class="input" label="手机" prop="shouji">
              <el-input v-model="ruleForm.shouji" 
                placeholder="手机" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="订单评价" prop="dingdanpingjia">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="订单评价"
                  v-model="ruleForm.dingdanpingjia" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dingdanpingjia" label="订单评价" prop="dingdanpingjia">
                    <span>{{ruleForm.dingdanpingjia}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	shhf : false,
            ...
            ruleForm: {
                  ...
                  dingdanpingfen: [
                            { required: true, message: '订单评分不能为空', trigger: 'blur' },
                                    	                                                              ],
                  dingdanpingjia: [
                            { required: true, message: '订单评价不能为空', trigger: 'blur' },
                                    	                                                              ],
                  pingjiariqi: [
                                    	                                                              ],
                  yonghuming: [
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dingdanbianhao = true;
            continue;
	            	            ...
	            	            if(o=='pingjiabiaoti'){
            this.ruleForm.pingjiabiaoti = obj[o];
	    this.ro.pingjiabiaoti = true;
            continue;
          }
	            	            if(o=='dingdanpingfen'){
            this.ruleForm.dingdanpingfen = obj[o];
	    this.ro.dingdanpingfen = true;
            continue;
          }
	            	            if(o=='dingdanpingjia'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.dingdanpingfenOptions = "1,2,3,4,5".split(',')
                                                                                                                                        },
                                                                                // 多级联动参数
                                                                                                      info(id) {
      this.$http({
