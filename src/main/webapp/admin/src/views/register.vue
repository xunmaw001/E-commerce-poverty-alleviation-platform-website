<template>
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.18);borderRadius:15px">
        <h1 class="h1" style="color:rgba(64, 158, 255, 1);fontSize:28px;">电商扶贫平台网站注册</h1>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                ...
                                                if(`yonghu` == this.tableName && this.ruleForm.jifen&&(!this.$validate.isNumber(this.ruleForm.jifen))){
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210219/4fdb5e41895b4ebe8c36d7804c15fa86.jpg");
		height: 100vh;
