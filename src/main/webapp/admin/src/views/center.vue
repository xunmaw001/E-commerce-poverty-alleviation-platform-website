     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yonghu'"  label="邮箱" prop="youxiang">
          <el-input v-model="ruleForm.youxiang"               placeholder="邮箱" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yonghu'"  label="积分" prop="jifen">
          <el-input v-model="ruleForm.jifen"               placeholder="积分" clearable></el-input>
        </el-form-item>
      </el-col>
...
export default {
  ...
  methods: {
        ...
        return
                                                ...
                                                if( 'yonghu' ==this.flag && this.ruleForm.jifen&&(!isNumber(this.ruleForm.jifen))){
