...
public class RemenshangpinController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,RemenshangpinEntity remenshangpin, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,RemenshangpinEntity remenshangpin, HttpServletRequest request){
        EntityWrapper<RemenshangpinEntity> ew = new EntityWrapper<RemenshangpinEntity>();
		PageUtils page = remenshangpinService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, remenshangpin), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R info(@PathVariable("id") Long id){
		...
		remenshangpin.setClicknum(remenshangpin.getClicknum()+1);
