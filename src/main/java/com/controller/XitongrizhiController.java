...
public class XitongrizhiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,XitongrizhiEntity xitongrizhi, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XitongrizhiEntity xitongrizhi, HttpServletRequest request){
        EntityWrapper<XitongrizhiEntity> ew = new EntityWrapper<XitongrizhiEntity>();
		PageUtils page = xitongrizhiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, xitongrizhi), params), params));
        return R.ok().put("data", page);
    }
